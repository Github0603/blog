...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<link rel="stylesheet" href="/blog/APP/admin/PUBLIC/Css/login.css" />
		...
		<script type="text/javascript" src="/blog/APP/admin/PUBLIC/Js/login.js"></script>
	</head>
	<body>
		<div id="top">
		...
		<div class="login">	
			...
			<table border="1" width="100%">
				...
				<tr>
					<th>验证码:</th>
					<td>
						<input type="code" class="len250" name="code"/><br /> <img src="<?php echo U('Admin/Login/verify');?>" id="code"/> <a href="javascript:void(change_code(this));">看不清</a>
					</td>
				</tr>
				<tr>
